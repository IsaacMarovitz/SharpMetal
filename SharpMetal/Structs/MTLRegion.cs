...
namespace SharpMetal
{
    ...
    public partial struct MTLRegion
    {
        ...
        public static implicit operator IntPtr(MTLRegion mtlRegion) => mtlRegion.NativePtr;
        ...
        public MTLOrigin Origin => new(ObjectiveCRuntime.IntPtr_objc_msgSend(NativePtr, sel_origin));
        public MTLSize Size => new(ObjectiveCRuntime.IntPtr_objc_msgSend(NativePtr, sel_origin));
